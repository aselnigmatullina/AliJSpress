document.addEventListener('DOMContentLoaded', () => {
    ...
    //функция для подсчета, сколько всего товаров в корзине
    ...
    const cookieQuery = get => {
        if (get) {
            ...
            checkCount()
        } else document.cookie = `goodsBasket=${JSON.stringify(goodsBasket)};max-age=86400e3`
    };
